...
given vecAD: VectorSpace[Array[Double], Double] =
...
given matAD(using
  ...
  new VectorSpace[Matrix[Double], Double] {
    ...
    override inline def zero: Matrix[Double] = Matrix.zeros(rc)
...
given nrootAD: NRoot[Array[Double]] = new NRoot[Array[Double]] {
  ...
  override inline def fpow(a: Array[Double], b: Array[Double]): Array[Double] =
  ...
  new Signed[Array[Double]] {
    ...
    override def additiveCommutativeMonoid
      ...
      new AdditiveCommutativeMonoid[Array[Double]] {
        ...
        override def zero: Array[Double] = Array.fill[Double](jd.dimension)(0.0)
...
given fadAD(using jd: JetDim): Field[Array[Double]] =
  new Field[Array[Double]] {
    inline override def negate(x: Array[Double]): Array[Double] = x * -1
    ...
    override inline def div(x: Array[Double], y: Array[Double]): Array[Double] =
      x / y

    override inline def one: Array[Double] =
      Array.fill[Double](jd.dimension)(1.0)
...
given trigAD(using jd: JetDim): Trig[Array[Double]] = new Trig[Array[Double]] {

  override def e: Array[Double] = Array.fill[Double](jd.dimension)(Math.E)

  override def pi: Array[Double] = Array.fill[Double](jd.dimension)(Math.PI)

  override inline def exp(a: Array[Double]): Array[Double] =
    a.clone().map(Math.exp)
  ...
  override inline def atan2(y: Array[Double], x: Array[Double]): Array[Double] =
